...
type SourceAdapter interface {
	...
	//
	// For example, the shares a user owns in the aeth:usdx and bnb:usdx swap pools.
	...
	//
	// For example, the total number of shares in the aeth:usdx swap pool for all users.
