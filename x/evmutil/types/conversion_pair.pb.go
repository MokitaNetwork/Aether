...
// source: aeth/evmutil/v1beta1/conversion_pair.proto
...
type ConversionPair struct {
	...
	AetherERC20Address HexBytes `protobuf:"bytes,1,opt,name=aeth_erc20_address,json=aethErc20Address,proto3,casttype=HexBytes" json:"aeth_erc20_address,omitempty"`
...
func init() {
	proto.RegisterType((*ConversionPair)(nil), "aeth.evmutil.v1beta1.ConversionPair")
}

func init() {
	proto.RegisterFile("aeth/evmutil/v1beta1/conversion_pair.proto", fileDescriptor_e1396d08199817d0)
}
...
func (this *ConversionPair) VerboseEqual(that interface{}) error {
	...
	if !bytes.Equal(this.AetherERC20Address, that1.AetherERC20Address) {
...
func (m *ConversionPair) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.AetherERC20Address) > 0 {
		...
		i = encodeVarintConversionPair(dAtA, i, uint64(len(m.AetherERC20Address)))
		i--
		dAtA[i] = 0xa
	}
...
func (m *ConversionPair) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			m.AetherERC20Address = append(m.AetherERC20Address[:0], dAtA[iNdEx:postIndex]...)
			if m.AetherERC20Address == nil {
				m.AetherERC20Address = []byte{}
			}
			iNdEx = postIndex
		case 2:
			if wireType != 2 {
