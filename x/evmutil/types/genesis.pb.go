...
// source: aeth/evmutil/v1beta1/genesis.proto
...
type Account struct {
	...
	// balance indicates the amount of aaeth owned by the address.
...
func init() {
	proto.RegisterType((*GenesisState)(nil), "aeth.evmutil.v1beta1.GenesisState")
	proto.RegisterType((*Account)(nil), "aeth.evmutil.v1beta1.Account")
	proto.RegisterType((*Params)(nil), "aeth.evmutil.v1beta1.Params")
}

func init() {
	proto.RegisterFile("aeth/evmutil/v1beta1/genesis.proto", fileDescriptor_d916ab97b8e628c2)
}
