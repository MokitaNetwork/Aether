...
func (suite *msgServerTestSuite) TestDeposit_ExistingPool() {
	...
	deposit := types.NewMsgDeposit(
		...
		suite.BankKeeper.GetBalance(suite.Ctx, depositor.GetAddress(), "uaeth"),
		sdk.MustNewDecFromStr("0.01"),
		time.Now().Add(10*time.Minute).Unix(),
	)
...
func (suite *msgServerTestSuite) TestWithdraw_AllShares() {
	...
	suite.PoolDeleted("uaeth", "usdx")
	suite.PoolSharesDeleted(depositor.GetAddress(), "uaeth", "usdx")
...
func (suite *msgServerTestSuite) TestWithdraw_PartialShares() {
	...
	minTokenA := sdk.NewCoin("uaeth", sdk.NewInt(4999999))
	...
	suite.PoolShareValueEqual(depositor, types.NewAllowedPool("uaeth", "usdx"), reserves.Sub(expectedCoinsReceived))
...
func (suite *msgServerTestSuite) TestWithdraw_SlippageFailure() {
	...
	minTokenA := sdk.NewCoin("uaeth", sdk.NewInt(5e6))
...
func (suite *msgServerTestSuite) TestSwapExactForTokens() {
	...
	swapInput := sdk.NewCoin("uaeth", sdk.NewInt(1e6))
	...
	suite.EventsContains(suite.GetEvents(), sdk.NewEvent(
		...
		sdk.NewAttribute(types.AttributeKeyPoolID, types.PoolID("uaeth", "usdx")),
		...
		sdk.NewAttribute(types.AttributeKeyFeePaid, "3000uaeth"),
...
func (suite *msgServerTestSuite) TestSwapForExactTokens() {
	...
	expectedSwapInput := sdk.NewCoin("uaeth", sdk.NewInt(1004015))
	...
	suite.EventsContains(suite.GetEvents(), sdk.NewEvent(
		...
		sdk.NewAttribute(types.AttributeKeyFeePaid, "3013uaeth"),
...
func (suite *msgServerTestSuite) TestSwapForExactTokens_SlippageFailure() {
	...
	swapMsg := types.NewMsgSwapForExactTokens(
		requester.GetAddress().String(),
		sdk.NewCoin("uaeth", sdk.NewInt(990991)),
		swapOutput,
		sdk.MustNewDecFromStr("0.01"),
		time.Now().Add(10*time.Minute).Unix(),
	)
