...
//
// For example, if we have a pool with 100e6 uaeth and 400e6 usdx.  The uaeth price is 4 usdx and the
// usdx price is 0.25 uaeth.  If a depositor adds liquidity of 4e6 uaeth and 14e6 usdx, a aeth price of
// 3.50 usdx and a usdx price of 0.29 uaeth.  This is a -12.5% slippage is the uaeth price, and a 14.3%
