...
// source: aeth/earn/v1beta1/tx.proto
...
type MsgDeposit struct {
	...
	Strategy StrategyType `protobuf:"varint,3,opt,name=strategy,proto3,enum=aeth.earn.v1beta1.StrategyType" json:"strategy,omitempty"`
}
...
func init() {
	proto.RegisterType((*MsgDeposit)(nil), "aeth.earn.v1beta1.MsgDeposit")
	proto.RegisterType((*MsgDepositResponse)(nil), "aeth.earn.v1beta1.MsgDepositResponse")
	proto.RegisterType((*MsgWithdraw)(nil), "aeth.earn.v1beta1.MsgWithdraw")
	proto.RegisterType((*MsgWithdrawResponse)(nil), "aeth.earn.v1beta1.MsgWithdrawResponse")
}

func init() { proto.RegisterFile("aeth/earn/v1beta1/tx.proto", fileDescriptor_2e9dcf48a3fa0009) }
...
func (c *msgClient) Deposit(ctx context.Context, in *MsgDeposit, opts ...grpc.CallOption) (*MsgDepositResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/aeth.earn.v1beta1.Msg/Deposit", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) Withdraw(ctx context.Context, in *MsgWithdraw, opts ...grpc.CallOption) (*MsgWithdrawResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/aeth.earn.v1beta1.Msg/Withdraw", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_Deposit_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/aeth.earn.v1beta1.Msg/Deposit",
	}
...
func _Msg_Withdraw_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/aeth.earn.v1beta1.Msg/Withdraw",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "aeth.earn.v1beta1.Msg",
	...
	Metadata: "aeth/earn/v1beta1/tx.proto",
}
