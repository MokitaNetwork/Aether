...
// source: aeth/liquid/v1beta1/query.proto
...
func init() {
	proto.RegisterType((*QueryDelegatedBalanceRequest)(nil), "aeth.liquid.v1beta1.QueryDelegatedBalanceRequest")
	proto.RegisterType((*QueryDelegatedBalanceResponse)(nil), "aeth.liquid.v1beta1.QueryDelegatedBalanceResponse")
	proto.RegisterType((*QueryTotalSupplyRequest)(nil), "aeth.liquid.v1beta1.QueryTotalSupplyRequest")
	proto.RegisterType((*QueryTotalSupplyResponse)(nil), "aeth.liquid.v1beta1.QueryTotalSupplyResponse")
}

func init() { proto.RegisterFile("aeth/liquid/v1beta1/query.proto", fileDescriptor_0d745428489be444) }
...
func (c *queryClient) DelegatedBalance(ctx context.Context, in *QueryDelegatedBalanceRequest, opts ...grpc.CallOption) (*QueryDelegatedBalanceResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/aeth.liquid.v1beta1.Query/DelegatedBalance", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) TotalSupply(ctx context.Context, in *QueryTotalSupplyRequest, opts ...grpc.CallOption) (*QueryTotalSupplyResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/aeth.liquid.v1beta1.Query/TotalSupply", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_DelegatedBalance_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/aeth.liquid.v1beta1.Query/DelegatedBalance",
	}
...
func _Query_TotalSupply_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/aeth.liquid.v1beta1.Query/TotalSupply",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Query_serviceDesc = grpc.ServiceDesc{
	ServiceName: "aeth.liquid.v1beta1.Query",
	...
	Metadata: "aeth/liquid/v1beta1/query.proto",
}
