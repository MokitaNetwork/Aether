...
// source: aeth/bep3/v1beta1/bep3.proto
...
type AssetParam struct {
	...
	// deputy_address the aeth address of the deputy
...
type AtomicSwap struct {
	...
	Status SwapStatus `protobuf:"varint,10,opt,name=status,proto3,enum=aeth.bep3.v1beta1.SwapStatus" json:"status,omitempty"`
	...
	Direction SwapDirection `protobuf:"varint,12,opt,name=direction,proto3,enum=aeth.bep3.v1beta1.SwapDirection" json:"direction,omitempty"`
}
...
func init() {
	proto.RegisterEnum("aeth.bep3.v1beta1.SwapStatus", SwapStatus_name, SwapStatus_value)
	proto.RegisterEnum("aeth.bep3.v1beta1.SwapDirection", SwapDirection_name, SwapDirection_value)
	proto.RegisterType((*Params)(nil), "aeth.bep3.v1beta1.Params")
	proto.RegisterType((*AssetParam)(nil), "aeth.bep3.v1beta1.AssetParam")
	proto.RegisterType((*SupplyLimit)(nil), "aeth.bep3.v1beta1.SupplyLimit")
	proto.RegisterType((*AtomicSwap)(nil), "aeth.bep3.v1beta1.AtomicSwap")
	proto.RegisterType((*AssetSupply)(nil), "aeth.bep3.v1beta1.AssetSupply")
}

func init() { proto.RegisterFile("aeth/bep3/v1beta1/bep3.proto", fileDescriptor_01a01937d931b013) }
