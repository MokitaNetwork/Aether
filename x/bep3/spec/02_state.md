...
- Incoming: assets are being sent to Aether from another blockchain.
- Outgoing: assets are being send to another blockchain from Aether.
...
- Current supply: the amount that the deputy has released - it is the active supply on Aether. It is equal to the total amount successfully claimed from incoming swaps minus the total amount claimed from outgoing swaps.
- Supply limit: the maximum amount currently allowed on Aether. The supply limit can be increased by Aether's stability committee, subject to an on-chain proposal vote.
