...
func NewFixtures(t *testing.T) *Fixtures {
	tmpDir, err := ioutil.TempDir("", "aeth_integration_"+t.Name()+"_")
...
// UnsafeResetAll is aethd unsafe-reset-all
...
// AddGenesisAccount is aethd add-genesis-account
...
// GDTendermint returns the results of aethd tendermint [query]
...
// ValidateGenesis runs aethd validate-genesis
